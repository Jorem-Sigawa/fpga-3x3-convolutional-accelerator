...
reg signed [15:0] c00,c01,c02,c10,c11,c12,c20,c21,c22; //9 multiplier
...
always @ (posedge clk) begin
    if (!nrst) begin
        ...
        c00 <= $signed({1'b0, a00})*b00; //9 multiplier, $signed reduces oen bit of range, adding another bit restores it
